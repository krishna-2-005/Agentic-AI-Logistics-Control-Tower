...
def render_doc(
    ...
    o.append(
        "- **Feature importances above are descriptive, not yet an ablation.** D3-D4 "
        "drops the corridor-history block and the temporal block from `FEATURES` and "
        "refits, to check the importance ranking against an actual MAE cost rather "
        "than reading it off the fitted model alone.\n"
